...
//Esse trecho coleta a data do dia atual, para poder inserir ele na url de consulta a api 
const data = new Date();
var dataFormatada = (((data.getMonth()+1)) + "-" + (data.getDate()) + "-" + data.getFullYear()).toLocaleString();
